...
/***/ "./app/pages/Animations/pages/lines/jelly/ball.js":
/*!********************************************************!*\
  !*** ./app/pages/Animations/pages/lines/jelly/ball.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mouse__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mouse */ \"./app/pages/Animations/pages/lines/jelly/mouse.js\");\n/* harmony import */ var _ball__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ball */ \"./app/pages/Animations/pages/lines/jelly/ball.js\");\n\n\n\nconst canvas = document.querySelector('#jelly');\n\nif (canvas) {\n  const mouse = new _mouse__WEBPACK_IMPORTED_MODULE_0__[\"default\"](canvas);\n  const ctx = canvas.getContext('2d');\n  const balls = [];\n  const mouseBall = new _ball__WEBPACK_IMPORTED_MODULE_1__[\"default\"](0, 0, 30, 'green');\n\n  for (let i = 0; i < 200; i++) {\n    balls.push(\n      new _ball__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\n        Math.random() * canvas.clientWidth,\n        Math.random() * canvas.clientHeight\n      )\n    );\n  }\n\n  render();\n\n  function render() {\n    window.requestAnimationFrame(render);\n    ctx.clearRect(0, 0, canvas.clientWidth, canvas.clientHeight);\n\n    balls.forEach((ball) => {\n      ball.think(mouse);\n      ball.draw(ctx);\n    });\n\n    mouseBall.setPosition(mouse.x, mouse.y);\n    mouseBall.draw(ctx);\n  }\n}\n\n\n//# sourceURL=webpack://tonephp/./app/pages/Animations/pages/lines/jelly/jelly.js?");

/***/ }),

/***/ "./app/pages/Animations/pages/lines/jelly/mouse.js":
/*!*********************************************************!*\
  !*** ./app/pages/Animations/pages/lines/jelly/mouse.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Mouse)\n/* harmony export */ });\nclass Mouse {\n  constructor(canvas) {\n    this.x = 0;\n    this.y = 0;\n\n    canvas.onmousemove = (e) => {\n      const rect = canvas.getBoundingClientRect();\n      this.x = e.clientX - rect.left;\n      this.y = e.clientY - rect.top;\n    }\n  }\n}\n\n//# sourceURL=webpack://tonephp/./app/pages/Animations/pages/lines/jelly/mouse.js?");
